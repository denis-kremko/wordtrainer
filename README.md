...
```
https://github.com/denis-kremko/wordtrainer/releases/download/dict-v6/dictionary-v6.sqlite.gz
```
...
3. Проверь URL:
   ```bash
   curl -IL https://github.com/denis-kremko/wordtrainer/releases/download/dict-v6/dictionary-v6.sqlite.gz
   # HTTP/2 200
   ```
...
2. `gh release create dict-v6 ...` (новый тег).
