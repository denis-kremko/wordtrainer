...
```
https://github.com/denis-kremko/wordtrainer/releases/download/dict-v9/dictionary-v9.sqlite.gz
```
...
3. Проверь URL:
   ```bash
   curl -IL https://github.com/denis-kremko/wordtrainer/releases/download/dict-v9/dictionary-v9.sqlite.gz
   # HTTP/2 200
   ```
...
2. `gh release create dict-v9 ...` (новый тег).
