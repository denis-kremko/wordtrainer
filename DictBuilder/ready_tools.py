...
THEMES = [
    ...
    ('drinks-bar', 'Drinks & Bar', 'cup.and.saucer',
     'Coffee, tea, and everything the bartender pours.',
     ['a-drinks-bar', 'b-drinks-bar', 'c-drinks-bar']),
    ('restaurants', 'Restaurants & Eating Out', 'fork.knife',
     'Menus, waiters, and the bill.',
     ['a-restaurants', 'b-restaurants', 'c-restaurants']),
    ('shopping', 'Shopping & Sales', 'cart',
     'Discounts, refunds, and the checkout.',
     ['a-shopping', 'b-shopping', 'c-shopping']),
    ('wine-gourmet', 'Wine & Gourmet', 'wineglass',
     'Tasting notes and fine food.',
     ['a-wine-gourmet', 'b-wine-gourmet', 'c-wine-gourmet']),
    ('beauty-grooming', 'Beauty & Grooming', 'comb',
     'Haircuts, skincare, and the mirror.',
     ['a-beauty-grooming', 'b-beauty-grooming', 'c-beauty-grooming']),
    ('birds-insects', 'Birds & Insects', 'ant',
     'Sparrows, beetles, and dragonflies.',
     ['a-birds-insects', 'b-birds-insects', 'c-birds-insects']),
    ('ocean-life', 'Ocean Life', 'fish',
     'Reefs, whales, and what lives below.',
     ['a-ocean-life', 'b-ocean-life', 'c-ocean-life']),
    ('gardening', 'Gardening & Plants', 'camera.macro',
     'Soil, seeds, and pruning.',
     ['a-gardening', 'b-gardening', 'c-gardening']),
    ('farm-countryside', 'Farm & Countryside', 'sun.horizon',
     'Barns, harvests, and village life.',
     ['a-farm-countryside', 'b-farm-countryside', 'c-farm-countryside']),
    ('mountains-climbing', 'Mountains & Climbing', 'mountain.2',
     'Summits, ropes, and thin air.',
     ['a-mountains-climbing', 'b-mountains-climbing', 'c-mountains-climbing']),
    ('energy-climate', 'Energy & Climate', 'bolt',
     'Solar panels, emissions, and the grid.',
     ['a-energy-climate', 'b-energy-climate', 'c-energy-climate']),
    ('news-media', 'News & Media', 'newspaper',
     'Headlines, sources, and breaking stories.',
     ['a-news-media', 'b-news-media', 'c-news-media']),
    ('religion-beliefs', 'Religion & Beliefs', 'hands.and.sparkles',
     'Temples, rituals, and faith.',
     ['a-religion-beliefs', 'b-religion-beliefs', 'c-religion-beliefs']),
    ('history-archaeology', 'History & Archaeology', 'scroll',
     'Empires, ruins, and digs.',
     ['a-history-archaeology', 'b-history-archaeology', 'c-history-archaeology']),
    ('manners-etiquette', 'Manners & Etiquette', 'hand.wave',
     'Please, thank you, and how to behave.',
     ['a-manners-etiquette', 'b-manners-etiquette', 'c-manners-etiquette']),
    ('psychology-habits', 'Psychology & Habits', 'puzzlepiece',
     'Memory, habits, and the inner life.',
     ['a-psychology-habits', 'b-psychology-habits', 'c-psychology-habits']),
    ('construction-machines', 'Construction & Machines', 'wrench.and.screwdriver',
     'Cranes, concrete, and blueprints.',
     ['a-construction-machines', 'b-construction-machines', 'c-construction-machines']),
    ('emergencies-firstaid', 'Emergencies & First Aid', 'light.beacon.max',
     'Sirens, bandages, and staying calm.',
     ['a-emergencies-firstaid', 'b-emergencies-firstaid', 'c-emergencies-firstaid']),
    ('photography', 'Photography & Cameras', 'camera',
     'Lenses, light, and the perfect frame.',
     ['a-photography', 'b-photography', 'c-photography']),
    ('aviation', 'Aviation & Flight', 'airplane.departure',
     'Cockpits, runways, and turbulence.',
     ['a-aviation', 'b-aviation', 'c-aviation']),
    ('spies-secrets', 'Secrets & Spies', 'binoculars',
     'Codes, covers, and shadowing.',
     ['a-spies-secrets', 'b-spies-secrets', 'c-spies-secrets']),
    ('humor-wit', 'Humor & Wit', 'theatermasks',
     'Puns, sarcasm, and perfect timing.',
     ['a-humor-wit', 'b-humor-wit', 'c-humor-wit']),
]
