export const meta = {
  name: 'dict-defs-quality',
  description: 'Rewrite synonym-chain definitions into simple explanations and delete redundant sibling senses',
...
Every sense id of every group must appear exactly once. Then call StructuredOutput with the summary counts {groups, kept, rewritten, deleted}.`,
  { label: `defs:${n}`, phase: 'Definitions', schema: SUMMARY, model: 'haiku' }
)))
